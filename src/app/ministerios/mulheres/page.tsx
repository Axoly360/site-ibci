      ...
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
        <Card className="flex flex-col items-start gap-4 p-8">
          ...
          <p className="text-sm leading-relaxed text-text-neutral/80">
            O Ministério de Mulheres promove comunhão, estudo da Palavra e
            apoio mútuo entre as mulheres da igreja, através de encontros e
            ações voltadas para o crescimento espiritual feminino.
          </p>
        </Card>
      </div>
    </div>
