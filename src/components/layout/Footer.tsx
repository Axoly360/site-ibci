...
function YoutubeIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M23.498 6.186a2.999 2.999 0 0 0-2.113-2.129C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.385.512A2.999 2.999 0 0 0 .502 6.186 31.26 31.26 0 0 0 0 12a31.26 31.26 0 0 0 .502 5.814 2.999 2.999 0 0 0 2.113 2.129c1.88.512 9.385.512 9.385.512s7.505 0 9.385-.512a2.999 2.999 0 0 0 2.113-2.129A31.26 31.26 0 0 0 24 12a31.26 31.26 0 0 0-.502-5.814zM9.75 15.568V8.432L15.818 12 9.75 15.568z" />
    </svg>
  );
}
